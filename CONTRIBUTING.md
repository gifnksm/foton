...
First off, thank you for considering contributing to foton.
...
[issue tracker](https://github.com/gifnksm/foton/issues),
...
[CHANGELOG](https://github.com/gifnksm/foton/blob/main/CHANGELOG.md)
...
```console
git clone https://github.com/gifnksm/foton
cd foton
cargo test
```
